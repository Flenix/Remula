...
public class SilvaniteGuiChest extends GuiContainer
{
    ...
    public SilvaniteGuiChest(IInventory par1IInventory, IInventory par2IInventory)
    {
    ...
    {
        int var4 = this.mc.renderEngine.getTexture("/co/uk/silvania/Remula/entity/silvanitechest.png");
