...
public class RenderAkatonian extends RenderLiving {
	...
	public RenderAkatonian(ModelBase par1ModelBase, float par2) {
		super(par1ModelBase, par2);
	}
	
	public void renderRobot(EntityAkatonian par1EntityRobot, double par2, double par4, double par6, float par8, float par9) {
		super.doRenderLiving(par1EntityRobot,  par2,  par4,  par6, par8,  par9);
	}
	
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
		this.renderRobot((EntityAkatonian)par1EntityLiving, par2, par4, par6, par8, par9);
	}
