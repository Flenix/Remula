...
public class RenderBronzeBullet extends Render {

	@Override
	public void doRender(Entity entity, double do0, double do1, double do2,
			float f, float f1) {
			this.loadTexture("/item/arrows.png");
			GL11.glPushMatrix();
			GL11.glTranslatef((float)do0, (float)do1, (float)do2);
