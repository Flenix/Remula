...
public class TeleporterXylexia extends Teleporter {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
			...
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48) {
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23) {
					...
					for (int var26 = this.worldServerInstance.getActualHeight() - 1; var26 >= 0; --var26) {
						if (this.worldServerInstance.getBlockId(var48, var26, var23) == Remula.xylexiaPortal.blockID) {
							while (this.worldServerInstance.getBlockId(var48, var26 - 1, var23) == Remula.xylexiaPortal.blockID) {
								--var26;
							}
		...
		if (var10 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlockId(var12 - 1, var13, var14) == Remula.xylexiaPortal.blockID) {
				var50 = 2;
			}
			...
			if (this.worldServerInstance.getBlockId(var12, var13, var14 - 1) == Remula.xylexiaPortal.blockID) {
				var50 = 3;
			}
   ...
   for (var19 = 0; var19 < 4; ++var19)
  {
    ...
    for (var20 = 0; var20 < 4; ++var20)
   {
    for (var21 = -1; var21 < 4; ++var21)
    {
     ...
     this.worldServerInstance.setBlock(var22, var23, var24, var33 ? Block.sandStone.blockID : Remula.xylexiaPortal.blockID);
    }
   }
