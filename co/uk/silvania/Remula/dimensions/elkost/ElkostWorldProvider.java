...
public class ElkostWorldProvider extends WorldProvider {
	...
	public void registerWorldChunkManager()	{
		this.worldChunkMgr = new ElkostChunkManager(worldObj.getSeed(), terrainType);
		this.hasNoSky = false;
	}
	
	public IChunkProvider createChunkGenerator() {
		return new ElkostChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	
	public static WorldProvider getProviderForDimension(int id) {
		return DimensionManager.createProviderFor(Remula.elkostDimension);
	}
