...
public class AkatoeChunkProvider implements IChunkProvider {
					...
					for (int l1 = 0; l1 < 8; ++l1) {
						...
						for (int i2 = 0; i2 < 4; ++i2) {
							...
							for (int k2 = 0; k2 < 4; ++k2) {
								if ((d16 += d15) > 0.0D) {
									//TODO Stone Block
									par3ArrayOfByte[j2 += short1] = (byte)Remula.akatoeStone.blockID;
								}
								else if (k1 * 8 + l1 < b2) {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		//If I comment this line out, then everything works but my world doesn't have the trees it wants :(
