...
{
    private Random deepSpaceRNG;
    private NoiseGeneratorOctaves noiseGen1;
    private NoiseGeneratorOctaves noiseGen2;
    private NoiseGeneratorOctaves noiseGen3;
    public NoiseGeneratorOctaves noiseGen4;
    public NoiseGeneratorOctaves noiseGen5;
    private World deepSpaceWorld;
    ...
    public DeepSpaceChunkProvider(World par1World, long par2)
    {
        this.deepSpaceWorld = par1World;
        this.deepSpaceRNG = new Random(par2);
        this.noiseGen1 = new NoiseGeneratorOctaves(this.deepSpaceRNG, 16);
        this.noiseGen2 = new NoiseGeneratorOctaves(this.deepSpaceRNG, 16);
        this.noiseGen3 = new NoiseGeneratorOctaves(this.deepSpaceRNG, 8);
        this.noiseGen4 = new NoiseGeneratorOctaves(this.deepSpaceRNG, 10);
        this.noiseGen5 = new NoiseGeneratorOctaves(this.deepSpaceRNG, 16);

        NoiseGeneratorOctaves[] noiseGens = {noiseGen1, noiseGen2, noiseGen3, noiseGen4, noiseGen5};
        noiseGens = TerrainGen.getModdedNoiseGenerators(par1World, this.deepSpaceRNG, noiseGens);
    ...
    {
        this.deepSpaceRNG.setSeed((long)par1 * 341873128712L + (long)par2 * 132897987541L);
        byte[] var3 = new byte[32768];
        this.biomesForGeneration = this.deepSpaceWorld.getWorldChunkManager().loadBlockGeneratorData(this.biomesForGeneration, par1 * 16, par2 * 16, 16, 16);
        this.generateTerrain(par1, par2, var3, this.biomesForGeneration);
        this.replaceBlocksForBiome(par1, par2, var3, this.biomesForGeneration);
        Chunk var4 = new Chunk(this.deepSpaceWorld, var3, par1, par2);
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Pre(par1IChunkProvider, deepSpaceWorld, deepSpaceWorld.rand, par2, par3, false));

        int var4 = par2 * 16;
        int var5 = par3 * 16;
        BiomeGenBase var6 = this.deepSpaceWorld.getBiomeGenForCoords(var4 + 16, var5 + 16);
        var6.decorate(this.deepSpaceWorld, this.deepSpaceWorld.rand, var4, var5);

        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Post(par1IChunkProvider, deepSpaceWorld, deepSpaceWorld.rand, par2, par3, false));
    ...
    {
        BiomeGenBase var5 = this.deepSpaceWorld.getBiomeGenForCoords(par2, par4);
