...
public class DeepSpaceWorldProvider extends WorldProvider {
	...
	public void registerWorldChunkManager()	{
		this.worldChunkMgr = new DeepSpaceChunkManager(worldObj.getSeed(), terrainType);
		this.hasNoSky = false;
	}
	
	public IChunkProvider createChunkGenerator() {
		return new DeepSpaceChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	
	public static WorldProvider getProviderForDimension(int id) {
		return DimensionManager.createProviderFor(Remula.deepSpaceDimension);
	}
