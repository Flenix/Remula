...
import co.uk.silvania.Remula.dimensions.TeleporterDeepSpace;
...
public class DeepSpacePortalBlock extends BlockPortal {

	public DeepSpacePortalBlock(int id) {
		super(id);
	...
	{
	         blockIcon = iconRegister.registerIcon("Remula:DeepSpacePortalBlock");
	}
