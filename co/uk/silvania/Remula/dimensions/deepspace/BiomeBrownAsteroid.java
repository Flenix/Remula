...
public class BiomeBrownAsteroid extends BiomeGenBase {
	...
	public BiomeBrownAsteroid(int id) {
		super(id);
		...
		this.topBlock = (byte) RemulaBlocks.deepSpaceBrownAsteroidRock.blockID;
		this.fillerBlock = (byte) RemulaBlocks.deepSpaceBrownAsteroidRock.blockID;
		this.maxHeight = 1.5F;
		this.minHeight = 0.2F;
