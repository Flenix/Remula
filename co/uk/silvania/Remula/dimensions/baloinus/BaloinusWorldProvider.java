...
public class BaloinusWorldProvider extends WorldProvider {
	
	private float[] colorsSunriseSunset = new float[4];
	
	public void registerWorldChunkManager()	{
		this.worldChunkMgr = new BaloinusChunkManager(worldObj.getSeed(), terrainType);
		this.hasNoSky = false;
	}
	
	public IChunkProvider createChunkGenerator() {
		return new BaloinusChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	
	public static WorldProvider getProviderForDimension(int id) {
		return DimensionManager.createProviderFor(Remula.baloinusDimension);
	}
