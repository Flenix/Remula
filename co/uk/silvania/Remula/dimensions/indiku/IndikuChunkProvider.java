...
public class IndikuChunkProvider implements IChunkProvider
{
    ...
    public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(Remula.indikuJungleBiome));
    ...
    public IndikuChunkProvider(World par1World, long par2, boolean par4)
    {
