...
public class IndikuChunkProvider implements IChunkProvider {
	...
	public IndikuChunkProvider(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
					...
					for (int l1 = 0; l1 < 8; ++l1) {
						...
						for (int i2 = 0; i2 < 4; ++i2) {
							...
							for (int k2 = 0; k2 < 4; ++k2) {
								if ((d16 += d15) > 0.0D) {
									par3ArrayOfByte[j2 += short1] = (byte) RemulaBlocks.indikuStone.blockID;//Block.stone.blockID;
								} else if (k1 * 8 + l1 < b2) {
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        for (int c = 60; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                int l3 = rand.nextInt(120);
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree1(true, 35 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree1(true, 35 + rand.nextInt(8), 1, 1).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree1(true, 35 + rand.nextInt(8), 2, 2).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree1(true, 35 + rand.nextInt(8), 3, 3).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree2(true, 35 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree2(true, 35 + rand.nextInt(8), 1, 1).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree2(true, 35 + rand.nextInt(8), 2, 2).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 4;
                ...
                int j5 = l + rand.nextInt(16) + 4;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.indikuGrass.blockID)) {
                	new IndikuGenHugeTree2(true, 35 + rand.nextInt(8), 3, 3).generate(worldObj, rand, j2, l3, j5);
                }
        }
