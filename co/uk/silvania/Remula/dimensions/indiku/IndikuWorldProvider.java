...
public class IndikuWorldProvider extends WorldProvider {
	...
	public void registerWorldChunkManager()	{
		this.worldChunkMgr = new IndikuChunkManager(worldObj.getSeed(), terrainType);
		this.hasNoSky = false;
	}
	
	public IChunkProvider createChunkGenerator() {
		return new IndikuChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	
	public static WorldProvider getProviderForDimension(int id) {
		return DimensionManager.createProviderFor(Remula.indikuDimension);
	}
