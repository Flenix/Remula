...
public class XylexiaPortalBlock extends BlockPortal {
	...
	public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4) {
		...
		byte var6 = 0;
			...
			if (par1World.getBlockId(par2 - 1, par3, par4) == Remula.xylexianStone.blockID || par1World.getBlockId(par2 + 1, par3, par4) == Remula.xylexianStone.blockID) {
				var5 = 1;
			}
			
			if (par1World.getBlockId(par2, par3, par4 - 1) == Remula.xylexianStone.blockID || par1World.getBlockId(par2, par3, par4 + 1) == Remula.xylexianStone.blockID) {
				var6 = 1;
			}
				...
				for (var7 = -1; var7 <= 2; ++var7) {
					for (var8 = -1; var8 <= 3; ++var8) {
						...
						if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3) {
							...
							if (var9) {
								if (var10 != Remula.xylexianStone.blockID) {
									return false;
								}
							}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
		...
		byte var7 = 1;
			...
			if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == Remula.xylexianStone.blockID) {
