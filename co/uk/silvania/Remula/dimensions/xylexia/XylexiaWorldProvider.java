...
public class XylexiaWorldProvider extends WorldProvider {
	...
	public void registerWorldChunkManager()	{
		this.worldChunkMgr = new XylexiaChunkManager(worldObj.getSeed(), terrainType);
		this.hasNoSky = false;
	}
	
	public IChunkProvider createChunkGenerator() {
		return new XylexiaChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	
	public static WorldProvider getProviderForDimension(int id) {
		return DimensionManager.createProviderFor(Remula.xylexiaDimension);
	}
