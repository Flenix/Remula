...
public class XylexiaChunkProvider implements IChunkProvider {
	...
	public XylexiaChunkProvider(World world, long seed, boolean mapFeaturesEnabled) {
		this.worldObj = world;
					...
					for (int l1 = 0; l1 < 8; ++l1) {
						...
						for (int i2 = 0; i2 < 4; ++i2) {
							...
							for (int k2 = 0; k2 < 4; ++k2) {
								if ((d16 += d15) > 0.0D) {
									par3ArrayOfByte[j2 += short1] = (byte) RemulaBlocks.xylexiaStone.blockID;//Block.stone.blockID;
								} else if (k1 * 8 + l1 < b2) {
			...
			for (int var9 = 0; var9 < 16; var9++) {
				...
				for (int var16 = 127; var16 >= 0; var16--) {
					...
					if (var16 <= 0 + this.rand.nextInt(5)) {
						...
						//TODO Stone
						else if (var18 != RemulaBlocks.xylexiaStone.blockID) {
							if (var13 == -1) {
								if (var12 == 0) {
									var14 = 0;

									//TODO Dirt
									var15 = (byte)RemulaBlocks.xylexiaStone.blockID;
								}
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        for (int c = 60; c > 0; c--) {
                ...
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.xylexiaStone.blockID)) {
                	new XylexiaGenTrees(true, 6 + rand.nextInt(8), 1, 1).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 8;
        ...
        for (int c = 50; c > 0; c--) {
                ...
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.xylexiaStone.blockID)) {
                	new XylexiaGenTrees(true, 6 + rand.nextInt(8), 2, 2).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 8;
                ...
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.xylexiaStone.blockID)) {
                	new XylexiaGenTrees(true, 6 + rand.nextInt(8), 3, 3).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 50; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 8;
                ...
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.xylexiaStone.blockID)) {
                	new XylexiaGenTrees(true, 6 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
        for (int c = 60; c > 0; c--) {
                int j2 = k + rand.nextInt(16) + 8;
        ...
        for (int c = 60; c > 0; c--) {
                ...
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.xylexiaStone.blockID)) {
                	new XylexiaGenForestTree(true).generate(worldObj, rand, j2, l3, j5);
                }
        }
        ...
        for (int c = 60; c > 0; c--) {
                ...
                int j5 = l + rand.nextInt(16) + 8;
                if ((worldObj.getBlockId(j2, l3, j5) == 0) && (worldObj.getBlockId(j2, l3 - 1, j5) == RemulaBlocks.xylexiaStone.blockID)) {
                	new XylexiaGenHugeTrees(true, 15 + rand.nextInt(8), 0, 0).generate(worldObj, rand, j2, l3, j5);
                }
        }
