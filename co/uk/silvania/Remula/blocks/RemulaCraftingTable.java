...
public class RemulaCraftingTable extends BlockContainer {

        public RemulaCraftingTable (int id) {
        ...
        player.openGui(Remula.instance, 3, world, x, y, z);
                return true;
        }
