...
public class TileEntityTecmoniumChest extends TileEntityChest implements IInventory
{
    private ItemStack[] tecmoniumChestContents = new ItemStack[56];

    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked = false;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTecmoniumChest adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTecmoniumChest adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTecmoniumChest adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTecmoniumChest adjacentChestZPosition;
    ...
    {
        return this.tecmoniumChestContents[par1];
    }
    ...
    {
        if (this.tecmoniumChestContents[par1] != null)
        {
            ItemStack var3;

            if (this.tecmoniumChestContents[par1].stackSize <= par2)
            {
                var3 = this.tecmoniumChestContents[par1];
                this.tecmoniumChestContents[par1] = null;
                this.onInventoryChanged();
                return var3;
            }
            else
            {
                var3 = this.tecmoniumChestContents[par1].splitStack(par2);

                if (this.tecmoniumChestContents[par1].stackSize == 0)
                {
                    this.tecmoniumChestContents[par1] = null;
                }
    ...
    public ItemStack getStackInSlotOnClosing(int par1)
    {
        if (this.tecmoniumChestContents[par1] != null)
        {
            ItemStack var2 = this.tecmoniumChestContents[par1];
            this.tecmoniumChestContents[par1] = null;
            return var2;
        }
        else
    ...
    {
        this.tecmoniumChestContents[par1] = par2ItemStack;
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.tecmoniumChestContents = new ItemStack[this.getSizeInventory()];
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i)
        {
            ...
            if (j >= 0 && j < this.tecmoniumChestContents.length)
            {
                this.tecmoniumChestContents[j] = ItemStack.loadItemStackFromNBT(nbttagcompound1);
            }
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        for (int i = 0; i < this.tecmoniumChestContents.length; ++i)
        {
            if (this.tecmoniumChestContents[i] != null)
            {
                NBTTagCompound nbttagcompound1 = new NBTTagCompound();
                nbttagcompound1.setByte("Slot", (byte)i);
                this.tecmoniumChestContents[i].writeToNBT(nbttagcompound1);
    ...
    private void func_90009_a(TileEntityTecmoniumChest par1TileEntityChest, int par2)
    {
