...
{
    private ItemStack[] silvaniteChestContents = new ItemStack[60];
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        for (int i = 0; i < nbttaglist.tagCount(); ++i)
        {
            ...
            if (j >= 0 && j < this.silvaniteChestContents.length)
            {
                this.silvaniteChestContents[j] = ItemStack.loadItemStackFromNBT(nbttagcompound1);
            }
        }
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        for (int i = 0; i < this.silvaniteChestContents.length; ++i)
        {
            if (this.silvaniteChestContents[i] != null)
            {
                NBTTagCompound nbttagcompound1 = new NBTTagCompound();
                nbttagcompound1.setByte("Slot", (byte)i);
                this.silvaniteChestContents[i].writeToNBT(nbttagcompound1);
    ...
    {
        ++this.numUsingPlayers;
        this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, RemulaBlocks.silvaniteChest.blockID, 1, this.numUsingPlayers);
    }
