package co.uk.silvania.Remula.tileentity.block;
...
public class TecmoniumChest extends BlockContainer {

        public TecmoniumChest (int id) {
        ...
        public TileEntity createNewTileEntity(World world) {
                return new TileEntityTecmoniumChest();
        }
}